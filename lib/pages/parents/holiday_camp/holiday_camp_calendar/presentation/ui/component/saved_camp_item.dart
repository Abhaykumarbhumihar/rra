              ...
              child: state.isTimeAddedLoading
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        var data =
                            state.selectedCampDatesModel.data.dates[index];
                                  ...
                                  children: <Widget>[
                                    Padding(
                                      ...
                                      child: SizedBox(
                                        ...
                                        child: TimeAdded(
                                          title:
                                              "$data\n${state.selectedCampDatesModel.data.session.fromTime.toFormattedTime} - ${state.selectedCampDatesModel.data.session.toTime.toFormattedTime}",
                                        ),
                                      ),
                                    ),
                                  ...
                                  onTap: () {
                                    showLogoutConfirmationDialog(
                                      ...
                                      yes: () async {
                                        ...
                                        BlocProvider.of<
                                                    HolidayCampCalendarBloc>(
                                                context)
                                            .add(RemoveSavedCampEvent(
                                                map, index));
                                      },
                                    );
                                  },
