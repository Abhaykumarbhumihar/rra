...
sealed class AttendanceEvent with _$AttendanceEvent {
  ...
  const factory AttendanceEvent.updateAttendanceStatus(Map<String,dynamic>data,
       int playerIndex,
       int recordIndex,) = UpdateAttendanceEvent;
  ...
  const factory AttendanceEvent.saveScrollToIndex(int index) = SaveListViewScroolToIndex;
